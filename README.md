...
- **🤖 Araştırma & Yapay Zeka** — Yapay zekanın biyomedikal uygulamaları üzerine araştırmalar yürütüyorum. Sağlık hizmetleri için yenilikçi algoritmalar geliştirmek ve gerçek zamanlı biyomedikal veri işleme için uç bilişim yaklaşımlarını keşfetmek temel odağım.
- **⚙️ Full Stack Geliştirme** — Hem frontend hem backend tarafında ölçeklenebilir uygulamalar tasarlıyor, REST API'ler geliştiriyorum.
- **🔌 IoT & Gömülü Sistemler** — Yapay zekayı tıbbi cihazlarla buluşturarak donanım + yazılım bütünleşik projeler geliştiriyorum.

---

## 🛠️ Teknik Beceriler & Stack
...
```python
ilgi_alanlari = {
    "🩺 Araştırma"    : "Sağlıkta Yapay Zeka — hastalık tespiti, medikal görüntü analizi",
    "🧠 Yapay Zeka"   : "Model eğitimi, derin öğrenme, sınıflandırma & tahmin",
    "⚙️ Backend"      : "Ölçeklenebilir API tasarımı, veritabanı optimizasyonu",
    "📊 Veri"         : "Veri temizleme, analiz, görselleştirme ve içgörü üretimi",
    "🔗 Entegrasyon"  : "AI + Backend'i birleştiren uçtan uca çözümler",
}
```
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/musaemredelen)
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:musadelen46@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Polsyia)
